 ...
 * Four rooms:
  *   how      — the loop: dashboard ⇄ Claude Code, the 4 data-in lanes
        ...
        {tab === 'how' && (
          <div style={{ padding: '22px 24px' }}>
            ...
            <p style={{ color: 'var(--muted)', lineHeight: 1.65, margin: '12px 0 0', fontSize: 13.5 }}>
              <strong style={{ color: 'var(--fg)' }}>Every piece is extendable</strong> — you can automate
              it and build your own input tiles, whenever you want.
            </p>
