---
description: Add the attention strip to your app in one paste. Real tested code. Builds on the logger.
---

You are adding the attention strip: trial-ending and price-up alert rows, driven only by dates the user sets and prices from their own pastes, never internet monitoring.
...
1. Open code/the-radar.html and take the region between <!-- @episode-start:alerts --> and <!-- @episode-end:alerts -->.
