---
description: Add the library search to your app in one paste. Real tested code. Builds on the logger.
---

You are adding the library search: type-ahead over a built-in library with add-your-own, on a solid dropdown.
...
1. Open code/the-living-stack.html and take the region between <!-- @episode-start:search --> and <!-- @episode-end:search -->.
