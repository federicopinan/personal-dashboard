---
description: Add the due radar to your app in one paste. Real tested code. Builds on the logger.
---

You are adding the due radar: the next-30-days timeline with proximity dots that heat up as a date closes in, and dates that roll themselves forward.
...
1. Open code/the-radar.html and take the region between <!-- @episode-start:radar --> and <!-- @episode-end:radar -->.
