---
description: Add the time blocks to your app in one paste. Real tested code. Builds on the logger.
---

You are adding the time blocks: the morning-to-bed day rail; turn a block off and its items flow to Anytime.
...
1. Open code/the-living-stack.html and take the region between <!-- @episode-start:blocks --> and <!-- @episode-end:blocks -->.
