---
description: Add the count-up number to your app in one paste. Real tested code. Builds on the logger.
---

You are adding the count-up number: the headline number that ticks to its new value instead of hard-cutting; any stat, money, reps, pages.
...
1. Open code/the-radar.html and take the region between <!-- @episode-start:burn --> and <!-- @episode-end:burn -->.
