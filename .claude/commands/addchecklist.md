---
description: Add the check-off list to your app in one paste. Real tested code. Builds on the logger.
---

You are adding the check-off list: tap-to-take rows with the fraction-fill progress bar and the satisfying pop.

STEP 0, THE FILES: the tested code ships at code/the-living-stack.html next to this command. If that file is NOT in this project, fetch the arsenal first, then continue:
...
1. Open code/the-living-stack.html and take the region between <!-- @episode-start:checklist --> and <!-- @episode-end:checklist -->.
