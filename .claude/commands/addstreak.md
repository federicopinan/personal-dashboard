---
description: Add sessions and streaks to your app in one paste. Real tested code. Builds on the logger.
---

You are adding sessions and streaks: finish-session saving, the celebration, and the beat-last-time loop.
...
1. Open code/the-living-logger.html and take the region between <!-- @episode-start:session --> and <!-- @episode-end:session -->.
