---
description: Add the overload chart to your app in one paste. Real tested code. Builds on the logger.
---

You are adding the overload chart: the top-set-over-time line with best-ever, scrubbing, and the draw-in reveal.
...
1. Open code/the-living-logger.html and take the region between <!-- @episode-start:chart --> and <!-- @episode-end:chart -->.
