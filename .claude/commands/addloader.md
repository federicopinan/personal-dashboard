---
description: Add the timing reader to your app in one paste. Real tested code. Builds on the logger.
---

You are adding the timing reader: the cozy reading loader that turns into rotating FOR YOU insight cards.
...
1. Open code/the-living-stack.html and take the region between <!-- @episode-start:loader --> and <!-- @episode-end:loader -->.
